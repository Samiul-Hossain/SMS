<?php
  ...
  $name=$date_of_birth=$mobile=$gender=$student_id=0;
  ...
  $csql = "SELECT c.course_name,s.section_no,r.day,r.time_start,r.time_end
          FROM student_class sc, class cl, section s, course c, routine r
...
if(isset($_POST['update'])){
  ...
  $sql="UPDATE students SET name='$name', date_of_birth='$date_of_birth', mobile='$mobile', gender='$gender' WHERE student_id=$id";
