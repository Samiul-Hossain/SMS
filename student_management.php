<?php
  ...
  if(isset($_POST['contactFrmSubmit']) ){
    ...
    $sql = "INSERT INTO students(name,gender,date_of_birth,mobile) VALUES ('$name','$gender','$date_of_birth','$mobile')";
...
<html>
 ...
 <div class="container-fluid">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
     ...
     <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
       ...
       <div class="d-flex justify-content-center">
           <div class="">
             <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalForm">Add Student</button>
           </div>
  ...
  //ADD STUDENT
    function submitContactForm(){
      ...
      if(name.trim() == ''){
        ...
        $.ajax({
            type:'POST',
            url:'http://localhost/sms/student_management.php',
            data:'contactFrmSubmit=1&name='+name+'&date='+date+'&mobile='+mobile+'&gender='+gender,
  ...
  <script>
  //DATA RETRIEVE AND PAGINATION
    $(document).ready(function(){
        function loadData(page){
          $.ajax({
            url : 'http://localhost/sms/student_pagination.php',
            type : "POST",
            cache : false,
            data : {page_no:page},
        ...
        $(document).on("click","#add_course",function(e){
          ...
          loadData();
          var sid = $(this).val();
          var student = document.getElementById(sid).innerText;
